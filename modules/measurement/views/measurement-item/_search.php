...
/* @var $model measurement\models\search\MeasurementItemSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="measurement-item-search advancedSearch"  style="<?=isset($_GET['searchForm']) ? '':'display: none;';?>" >
