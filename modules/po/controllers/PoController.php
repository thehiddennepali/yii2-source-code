...
use po\models\search\PurchaseOrderSearch;
                ...
                'rules' => [
                    [
                        ...
                        'matchCallback' => function($rule, $action){
                            return Yii::$app->user->can('createPo');
                        }
                    ],
                    [
                        'actions' => ['update'],
                        ...
                        'matchCallback' => function($rule, $action){
                            ...
                            return Yii::$app->user->can('updatePo', ['model' => $this->findModel($_GET['id'])]);
                        }
                    ],
                    [
                        'actions' => ['delete'],
                        ...
                        'matchCallback' => function($rule, $action){
                            if(!isset($_GET['id']))
                                throw new Exception("id parameter is missing");
                            return Yii::$app->user->can('deletePo', ['model' => $this->findModel($_GET['id'])]);
                        }
                    ],
                    [
                        'actions' => ['view'],
                        ...
                        'matchCallback' => function($rule, $action){
                            if(!isset($_GET['id']))
                                throw new Exception("id parameter is missing");
                            return Yii::$app->user->can('viewPo', ['model' => $this->findModel($_GET['id'])]);
                        }
                    ],
                    [
                        'actions' => ['index'],
                        'allow' => true,
                        'matchCallback' => function($rule, $action){
                            return Yii::$app->user->can('indexPo');
                        }
                    ],
                ],
            ],
