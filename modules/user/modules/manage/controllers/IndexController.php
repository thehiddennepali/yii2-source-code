...
class IndexController extends UserController
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            $token = Token::create(Token::ACTION_ACTIVATE_ACCOUNT_FROM_ADMINISTRATOR, $model);
            Yii::$app->mailer->compose('activateAccount-html', ['user' => $model, 'token'=>$token,])
                ->setFrom([Yii::$app->params['supportEmail'] => Yii::$app->name])
                ->setTo([$model->email=>$model->fullName])
                ->setSubject(Yii::t('app', 'You have registered by administrator. Here is a link to activate your account.'))
                ->send();
    ...
    public function actionResetPassword($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate())
        {
            ...
            $model->save(false);
            Yii::$app->session->setFlash('successMessage', Yii::t('app', 'You successfully changed password'));
            return $this->refresh();
        } else {
