...
<div class="user-form">
    ...
    if(Yii::$app->user->can('createUser'))
    {
        ...
        <?= $form->field($model, 'status')->dropDownList($model->statusValues,  array('prompt'=>Yii::t('app', 'Select'))); ?>
        <?php
    }
    ?>
    <?php
    ...
    <div class="row">
        <div class="form-group">
            <div class="col-lg-4 "><?= Html::submitButton(Yii::t('app', 'Save'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?></div>
        </div>
    </div>
