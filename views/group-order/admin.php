...
$this->breadcrumbs = array(
    Yii::t('basicfield','Table Booking') => array('index'),
    ...
    <div class="col-md-3">
        <div class="box box-default collapsed-box box-solid">
            <div class="box-header with-border">
                <h3 class="box-title"><?=Yii::t('basicfield','Free Orders')?> (<?=count($freeOrders)?>)</h3>
        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                ...
                <?php $this->widget(
                    ...
                    array(
                        'context' => 'info',
                        'label' => Yii::t('basicfield','Find staff'),
                        'url' => '#',
                ...
                <?php echo $form->dropDownListGroup($model, 'staff_id'
                    , array(
                        'widgetOptions' => array(
                            'data' => [],
                            'htmlOptions' => array('prompt' => Yii::t('basicfield','Select Staff'), 'class' => 'span5',
                ...
                <?php $this->widget(
                    ...
                    array(
                       // 'buttonType' => 'ajaxButton',
                        'context' => 'info',
                        'label' => Yii::t('basicfield','Find Free Time Slots'),
                        //'url' => Yii::app()->createUrl('tableBooking/getStaffFreeTime'),
                ...
                <?php echo $form->dropDownListGroup($model, 'free_time_list', array(
                        'widgetOptions' => array(
                            'data' => [],
                            'htmlOptions' => array('prompt' => Yii::t('basicfield','Select Free Time'), 'class' => 'span5',
