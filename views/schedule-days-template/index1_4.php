...
/* @var $searchModel common\models\ScheduleDaysTemplateSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('basicfield', 'Schedule Days Templates');
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="box">
    <div class="box-header">
        <h1 class="box-title"><?=Yii::t('basicfield', 'Manage Schedule Days Templates')?></h1>
    </div>
    <div class="box-body">
<?php Pjax::begin(); ?> 
   <?= GridView::widget([
